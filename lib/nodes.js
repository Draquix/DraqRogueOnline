...
const forge = {
    name:"The Forge",
    metal1:{name:"na",purity:0},
    metal2:{name:"na",purity:0},
    inUse:false,
    recipes:["",
    [//forging 1
        {name:"tin bar",
...
smelt: function(lvl,num){
    ...
    if(item.metal1===this.metal1.name){
        this.metal1.purity -= .5;
    } else if(item.metal1===this.metal2.name){
        this.metal2.purity -= .5;
    }
    if(item.metal2===this.metal1.name){
        this.metal1.purity -= .5;
