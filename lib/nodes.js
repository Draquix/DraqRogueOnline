...
const copperMine = {
    ...
    onSuccess: function(){
        ...
        let ore = new obj.Ore("copper ore",purity.toFixed(2),1,.5);
        return [ore,this.xp];
    }
}
const tinMine = {
    ...
    onSuccess: function(){
        let purity = Math.random()*(this.highest-this.lowest)+this.lowest;
        let ore = new obj.Ore("tin ore",purity.toFixed(2),1,.5);
        return [ore,this.xp];
    }
}
const ironMine = {
    ...
    onSuccess: function(){
        let purity = Math.random()*(this.highest-this.lowest)+this.lowest;
        let ore = new objOre("iron ore",purity.toFixed(2),1,1);
        return [ore,this.xp];
    }
}
const firTree = {
...
module.exports = { NPCBox, getNode,copperMine, tinMine, firTree, oakTree, fishPond, fishStream};