...
this.smelt = function(lvl,num){
    ...
    if(item.metal1===this.metal1.name&&item.metal1!=item.metal2&&this.metal1.purity>=.5){
        ...
        allow1 = true;
    } else if(item.metal1===this.metal2.name&&item.metal1!=item.metal2&&this.metal2.purity>=.5){
        this.metal2.purity -= .5;
        allow1 = true;
    } else if(item.metal2===this.metal1.name&&item.metal1!=item.metal2&&this.metal1.purity>=.5){
        this.metal1.purity -= .5;
        allow2 = true;
    } else if(item.metal2===this.metal2.name&&item.metal1!=item.metal2&&this.metal2.purity>=.5){
        this.metal2.purity -= .5;
        allow2 = true;
